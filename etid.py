...
def create_account():
    ...
    user_id = create_account_next_id()
...
def deposit_money():
    ...
    accounts[acc_no]["transactions"].append(f"Deposit: +{amount}")
    save_accounts()
...
def withdraw_money():
    ...
    accounts[acc_no]["balance"] -= amount
    accounts[acc_no]["transactions"].append(f"Withdrawal: -{amount}")
    save_accounts()
...
def view_transaction_history():
    ...
    if not acc_no:
        return
    print(f"\nTransaction History for {acc_no} ({accounts[acc_no]['name']}):")
